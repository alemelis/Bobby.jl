@testset "rook.jl" begin
    ...
    @test Bb.ROOK_MASKS[Bb.sq2idx(p2u["a1"])] == Bb.MASK_RANKS[1] | Bb.MASK_FILES[1] ⊻ p2u["a1"] ⊻ p2u["a8"] ⊻ p2u["h1"]
    @test Bb.ROOK_MASKS[Bb.sq2idx(p2u["h8"])] == Bb.MASK_RANKS[8] | Bb.MASK_FILES[8] ⊻ p2u["h8"] ⊻ p2u["a8"] ⊻ p2u["h1"]
    @test Bb.rookMasksGen()[Bb.sq2idx(p2u["e4"])] == (Bb.MASK_RANKS[4] | Bb.MASK_FILES[5] ⊻ p2u["e4"] ⊻
                                           p2u["e8"] ⊻ p2u["e1"] ⊻ p2u["a4"] ⊻ p2u["h4"])
