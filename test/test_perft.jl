...
@testset "perft3" begin
    res = [14, 191] #, 2812, 43238]
    @test test_fen(
        "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 1 1", length(res), res)
end
